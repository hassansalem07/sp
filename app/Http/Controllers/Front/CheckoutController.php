...
class CheckoutController extends Controller
{
    ...
    public function shippingStore(Request $request)
    {
        ...
        $cart = Session::get('cart');
        $city = ShippingCity::where('id',$request->city)->first();
        ...
        return view('front.checkout.payment',compact('data','user'));
    ...
    public function submit_order(Request $request)
    {
        ...
        $city = ShippingCity::where('name',$request->city)->first();
// return $request;
        Order::create([
            'user_id' => $user->id ?? 0,
            'cart' => $request->cart,
            ...
            'shipping' => $city->price,
            'shipping_info' => '{"ship_first_name":"'.$request->first_name.'","ship_last_name":"'.$request->last_name.'","ship_email":"'.$request->email.'","ship_phone":"'.$request->phone.'","ship_company":null,"ship_address1":"'.$request->address.'","ship_address2":null,"ship_zip":null,"ship_city":"'.$request->city.'","ship_country":"'.$request->street.'"}',
        ]);
