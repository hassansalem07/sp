            ...
            <div class="card">
                <div class="card-body">    
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-3">
                                36: <input class="form-control" name="36" value="0" min="0" type="number">
                                37: <input class="form-control" name="37" value="0" min="0" type="number">
                                38: <input class="form-control" name="38" value="0" min="0" type="number">
                            </div>
                            <div class="col-3">
                                39: <input class="form-control" name="39" value="0" min="0" type="number">
                                40: <input class="form-control" name="40" value="0" min="0" type="number">
                                41: <input class="form-control" name="41" value="0" min="0" type="number">
                            </div>
                            <div class="col-3">
                                42: <input class="form-control" name="42" value="0" min="0" type="number">
                                43: <input class="form-control" name="43" value="0" min="0" type="number">
                                44: <input class="form-control" name="44" value="0" min="0" type="number">
                            </div>
                            <div class="col-3">
                                45: <input class="form-control" name="45" value="0" min="0" type="number">
                                46: <input class="form-control" name="46" value="0" min="0" type="number">
                            </div>
                        </div>
                    </div>
                </div>
