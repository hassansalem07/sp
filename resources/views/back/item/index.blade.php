                ...
                <h3 class="mb-0 bc-title"><b>{{ __('All Products') }}</b></h3>
                    <div class="right">
                        ...
                        <form class="d-inline-block" action="{{route('back.bulk.delete')}}" method="get">
                            ...
                            <button class="btn btn-danger btn-sm">{{__('Delete Selected')}}</button>
                        </form>
                    </div>
                </div>
        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6" >
                            <div class="form-group px-0">
                                <select class="form-control" name="orderby">
                                    ...
                                    <option value="asc" {{request()->input('orderby') == 'asc' ? 'selected' : ''}}>{{__('order by oldest')}}</option>
                                    <option value="desc" {{request()->input('orderby') == 'desc' ? 'selected' : ''}}>{{__('order by latest')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
