            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            @php
                                $ship = json_decode($order->shipping_info);
                            @endphp
                            {{-- {{dd($ship->ship_first_name)}} --}}
                            <div class="row">
                               ...
                               <div class="col-12 col-md-6">
                                  <h5>{{__('Shipping Address :')}}</h5>
                                      ...
                                      @endphp
                                          ...
                                          <span class="text-muted">{{__('Street')}}: </span>{{$ship['ship_country']}}<br>
                                          @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-0">
                                            ...
                                            <span class="entry-meta"><b>{{$option_name}}</b> :
                                                ...
                                                LE  {{round($item['attribute']['option_price'][$optionkey],2)}}
                                                @else
                                                {{round($item['attribute']['option_price'][$optionkey],2)}} LE
                                                @endif
...
{{-- {{dd($order->currency_value)}} --}}
                                        <td class="px-0 text-right">
                                            ...
                                            @if ($setting->currency_direction == 1)
                                                LE  {{round($item['main_price'],2)}}
                                            @else
                                                {{round($item['main_price'],2)}} LE
                                            @endif
                                        </td>
                                        </tr>
                                    @endforeach
                                        ...
                                        <td class="px-0 text-right border-top border-top-2" colspan="5">
                                            ...
                                            @if ($setting->currency_direction == 1)
                                                -LE {{round($discount['discount'] ,2)}}
                                            @else
                                                -{{round($discount['discount'] ,2)}} LE
                                            @endif
                                            </span>
                                        </td>
                                        </tr>
                                        ...
                                        <td class="px-0 text-right border-top border-top-2" colspan="5">
                                            <span >
                                            @if ($setting->currency_direction == 1)
                                            {{isset($state['type']) && $state['type'] == 'percentage' ?  ' ('.$state['price'].'%) ' : ''}}  LE {{round($order['state_price'],2)}}
                                            @else
                                            {{isset($state['type']) &&  $state['type'] == 'percentage' ?  ' ('.$state['price'].'%) ' : ''}}  {{round($order['state_price'],2)}} LE 
                                            @endif
                                        ...
                                        <td class="px-0 text-right border-top border-top-2" colspan="5">
                                            <span class="h3">
                                                LE {{PriceHelper::OrderTotal($order)}}
                                            </span>
                                        </td>
                                        </tr>
                                    </tbody>
