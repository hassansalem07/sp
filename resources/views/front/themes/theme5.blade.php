            ...
            <div class="container">
                ...
                <div class="row g-3">
                    ...
                    <div class="popular-category-slider owl-carousel">
                        ...
                        @if(isset($campaign_item->item))

                        <div class="slider-item">
                            <div id="pop-cat" class="product-card" style="height: 25rem;">
                                <div class="product-thumb">
                                    ...
                                    @endif
                                   <a href="{{route('front.product',$compaign_item->item->slug)}}"> <img class="lazy" data-src="{{asset('assets/images/'.$compaign_item->item->thumbnail)}}" alt="Product"></a>
                                    ...
                                    <div class="product-card-body" style="height: 25rem;">
    ...
    @if ($setting->is_popular_category == 1)
        <section class="newproduct-section popular-category-sec mt-50">
            <div class="container">
                ...
                <div class="popular_category_view d-none" style="height: 25rem;">
                ...
                <div class="row" id="popular_category_view">
                    <div class="col-lg-12">
                        <div class="popular-category-slider  owl-carousel">
                            ...
                            <div class="slider-item">
                                <div class="product-card" style="height: 25rem;">
                                    <div class="product-thumb" >
                                        ...
                                        @endif
                                        {{-- here we go --}}
                                          <a href="{{route('front.product',$popular_category_item->slug)}}"><img class="lazy" data-src="{{asset('assets/images/'.$popular_category_item->thumbnail)}}" alt="Product"></a> 
                                ...
                                @if ($item->is_type == 'feature')
                                    <div class="slider-item">
                                        ...
                                        <div class="product-card" style="height: 25rem;">
                                            ...
                                            <div class="product-card-inner" style="height: 25rem;">
        ...
        <div class="flash-sell-area mt-50">
            <div class="container">
                <div class="row gx-3 justify-content-center">
                    @if(!empty($two_column_categoriess))
