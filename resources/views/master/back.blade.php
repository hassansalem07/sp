...
<head>
	...
	<script>
        var images_path = "{{ asset('assets/images') }}";
    </script>
	<!-- CSS Files -->
				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item mr-4">
							<a class="btn btn-sm btn-primary py-1 text-white" title="pos" href="{{route('pos.index')}}" target="_blank">
							<b> {{ __('POS') }}</b>
							</a>
						</li>
			...
			<div class="sidebar-wrapper scrollbar-inner">
				<div class="sidebar-content">
                    ...
                    <div class="sidebar-footer text-primary d-block text-center pt-3">
                        {{-- <span class="d-inline-block"><b>Version  4.8.0</b></span> --}}
                    </div>
...
<script>
    ...
    <script src="{{ asset('assets/pos/js/pos.js') }}"></script>
	<script src="{{ asset('assets/pos/js/jquery.number.min.js') }}"></script>
