...
@if ($setting->is_loader == 1)
<div id="preloader">
    <img src="{{ asset('assets/images/1634218044logoforsite.png') }}" alt="{{ __('Loading...') }}">
</div>
@endif
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <section class="widget widget-light-skin">
            ...
            <ul class="list-unstyled text-sm">
              <li><span class=""><strong>{{__('Every Day')}}: </strong></span>{{$setting->friday_start}} - {{$setting->friday_end}}</li>
