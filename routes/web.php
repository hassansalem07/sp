...
Route::post('submit-order',[CheckoutController::class,'submit_order'])->name('submit.order');


// POS

Route::get('admin/pos', 'Back\PosController@index')->name('pos.index');
Route::get('admin/pos/create', 'Back\PosController@create')->name('pos.create');
Route::get('admin/pos/products/{order_id}', 'Back\PosController@order_products')->name('pos.order.products');
Route::get('admin/pos/invoice/{order_id}', 'Back\PosController@invoice')->name('pos.order.invoice');
Route::post('admin/pos/store', 'Back\PosController@store')->name('pos.store');
Route::post('admin/pos/sub-category', 'Back\PosController@sub_category')->name('pos.sub.category');
Route::post('admin/pos/sub-category/products', 'Back\PosController@get_sub_category_products')->name('pos.sub.category.products');
Route::post('admin/pos/discount', 'Back\PosController@pos_discount')->name('pos.discount');
